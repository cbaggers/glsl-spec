...
(defparameter *variables*
  '((:name "gl_maxClipDistances" :type "int" :place-p t :versions (150 330 400 410 420 430 440 450))
    ...
    (:name "gl_fragCoord" :type "vec4" :place-p t :versions (110 120 130 140 150 330 400 410 420 430 440 450) :stage :fragment)
    ...
    (:name "gl_fragDepth" :type "float" :place-p nil :versions (110 120 130 140 150 330 400 410 420 430 440 450) :stage :fragment)
